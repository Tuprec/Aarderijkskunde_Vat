...
<body style="background-color: #000000">
    <form id="form1" runat="server" aria-orientation="vertical" aria-required="False" style="background-color: #000000">
        ...
        <h1 style="color: #FFFFFF">Momenteel is er <asp:Label ID="lblTotaalWater" runat="server" Text="93 000" style="display:inline-block;height:40px;"></asp:Label>  km³ drinkabaar water.</h1>
